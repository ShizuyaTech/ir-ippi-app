                                ...
                                <form action="{{ route('dashboard-scores.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="ir_partnership" name="ir_partnership" value="{{ old('ir_partnership') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('conductive_working_climate') }}" min="0" max="100"
                                            step="0.01" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('ess') is-invalid @enderror"
                                            id="ess" name="ess" value="{{ old('ess') }}" min="0"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('airsi') is-invalid @enderror"
                                            id="airsi" name="airsi" value="{{ old('airsi') }}" min="0"
                                            max="100" step="0.01" required>
                                        @error('airsi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
